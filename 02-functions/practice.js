...
// together.
var add = function (numFirst, numSecond) {
...
//     //=> queen of hearts
var cardString = function (cardRank, cardSuit) {
...
var toTagString = function (tagName,tagContent) {
	return openTag(tagName) + tagContent + closeTag(tagName);
};
